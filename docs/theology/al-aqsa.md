...
For in reality, this is a war over a holy site—over the holy Al-Aqsa Mosque, the first qibla (the direction of Islamic prayer). In the understanding of most Muslims, the Jews who have returned to Jerusalem intend to build the [Third Temple](https://en.wikipedia.org/wiki/Third_Temple) on the site of Islamic holy places, which means demolishing the mosque.
...
There is a widespread view that the mosque mentioned in this passage of the Quran is the mosque currently located on the Temple Mount in Jerusalem, now called "[Al-Aqsa](https://en.wikipedia.org/wiki/Al-Aqsa_Mosque)." But this is not so.

## The History of the Modern Structures

[Umar ibn al-Khattab](https://en.wikipedia.org/wiki/Umar) conquered Jerusalem in 637 CE. According to tradition (sources: al-Tabari, Eutychius of Alexandria), he built a simple wooden prayer house ([musalla](https://en.wikipedia.org/wiki/Musalla)) in the southern part of the Temple Mount—a temporary structure that was not a full-fledged mosque.

The present stone mosque called "Al-Aqsa" was erected under the Umayyads: construction began under [Abd al-Malik ibn Marwan](https://en.wikipedia.org/wiki/Abd_al-Malik_ibn_Marwan) around the 690s CE, and was completed under his son [al-Walid I](https://en.wikipedia.org/wiki/Al-Walid_I) around 705–715 CE. The building was rebuilt multiple times following earthquakes.

The Quran was recorded during Muhammad's lifetime from 610 to 632 CE, and was finally codified under Caliph [Uthman](https://en.wikipedia.org/wiki/Uthman) around 650 CE.
...
Here it should be noted that in both the first ayah, which speaks of the farthest mosque, and in the seventh, which speaks of the mosque of the Jews that the enemies invaded, one and the same word [مسجد](https://en.wikipedia.org/wiki/Mosque) (masjid) is used, which is usually translated as "mosque."
...
It is reported that Muhammad's companion [Al-Bara' ibn Azib](https://en.wikipedia.org/wiki/Al-Bara%27_ibn_Azib) said:
...
Source: [Sahih al-Bukhari 40](https://sunnah.com/bukhari:40) (Some theologians consider Sahih al-Bukhari the most authentic Islamic book after the Quran.)

What is "Bayt al-Maqdis" (بَيْتِ الْمَقْدِسِ)?

This is a borrowing from Hebrew; in Hebrew it is "Beit HaMikdash" ([בֵּית הַמִּקְדָּשׁ](https://en.wikipedia.org/wiki/Temple_in_Jerusalem)). This is the Hebrew name for [the Holy Temple](https://en.wikipedia.org/wiki/Temple_in_Jerusalem).
...
According to the Quran, can Banu Israil once again regain what was twice lost? Yes, this possibility is directly stated in the Quran in the same surah ([17:8](https://quran.com/17/8)):
...
[Discussion on Facebook of an earlier version of this article](https://www.facebook.com/viktor.ageyev/posts/pfbid02vj17jBzVgYDTZp4rAhd9ekggKAGT1C7Tx4ZS4MRKZhp2aAVkwqBCRtZ42P8zv5j5l)
