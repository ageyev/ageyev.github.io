...
«Угоди Авраама» висять поки що в повітрі, бо тримаються лише на економіці та страху перед Іраном. Їм запекло не вистачає теологічного базису, який би виправдав нормалізацію стосунків з Ізраїлем в очах арабської вулиці.
