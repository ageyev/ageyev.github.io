...
I was looking for an extension with open code, that can be installed from [source code](https://github.com/highlighter-pro/highlighter) as like as from the [Chrome Web Store](https://chromewebstore.google.com/detail/highlighterpro/gpdhplhmppgenpnkfilghnjiodfmnoap), that does not collect any data from user, and, as is often the case, I ended up writing my own.
