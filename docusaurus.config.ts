        ...
        [
            'classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/ageyev/ageyev.github.io/blob/master/',
                    // Localize edit URLs
    ...
    themeConfig: {
        ...
        footer: {
            ...
            links: [
                {
                    html: `
                <nav aria-label="Social links" class="footer-socials">
                    <!--       YouTube      -->
                    <a href="https://www.youtube.com/@international-law-info" target="_blank" title="YouTube" class="footer_icon" aria-label="YouTube">
                    ...
                    <!--       X      -->
                    <a href="https://x.com/ageyev" target="_blank" title="X.com" class="footer_icon" aria-label="X">
            ...
            copyright: `Copyright © ${new Date().getFullYear()}, Viktor Ageyev `,
            // copyright: `Copyright © 2026, Viktor Ageyev`,
