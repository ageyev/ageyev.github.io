...
On September 15, 2022, the spokeswoman for the Ministry of Foreign Affairs of the Russian Federation Maria Zakharova [said](https://mid.ru/en/foreign_policy/news/1829920/#27) (see [video](https://www.youtube.com/watch?v=F1dBWV6Y4Hg)) that the person who develops the mechanism for the removing of the Russian Federation from the UN Security Council deserves a Nobel Prize, because legally, such a scenario is impossible.
...
This rule was formulated in the [opinion](https://ageyev.github.io/documents/un-ussr-rf/un/1947-10-08_Sixth_Commitee_Letter.pdf) (A/C.1/212) of the Sixth (Legal) Committee of the UN General Assembly back in 1947:
...
In other words, if there have been changes in the state (government, constitution, territory, name), but this state continues to have the same [international legal personality](https://en.wikipedia.org/wiki/International_legal_personality), or, in other words, to be the same subject of international law ("*continuing state*" or "*continuator*"), then it continues to be a member of the UN.
...
See [Telegram of the UN Secretary General Perez de Cuellar to Security Council members with Yeltsin and Vorontsov letters attached](https://ageyev.github.io/documents/un-ussr-rf/un/1991-12-24_Telegram_of_Perez_de_Cuellar_with_RF_Letters_attached.pdf)
...
We now have documents that shed light on this question. What makes this particularly intriguing is not just the content of these documents, but the fact that a key document was *classified* within the UN [until 2022](https://ageyev.github.io/documents/un-ussr-rf/ukraine/2022-03-04_Note_Verbale_from_the_Office_of_Legal_Affairs_to_the_Permanent_Mission_of_Ukraine.pdf). The very fact that this document was kept secret from 1991 to 2022 suggests that those involved were aware of the unlawful nature of their actions.

This document is the [internal memorandum dated December 19, 1991](https://ageyev.github.io/documents/un-ussr-rf/un/1991-12-19_Interoffice_memorandum_Fleischhauer.pdf), sent by the then [UN Under-Secretary-General for Legal Affairs](https://en.wikipedia.org/wiki/Office_of_Legal_Affairs_(United_Nations)) [Carl-August Fleischhauer](https://en.wikipedia.org/wiki/Carl-August_Fleischhauer) to the then UN Secretary-General [Pérez de Cuéllar](https://en.wikipedia.org/wiki/Javier_P%C3%A9rez_de_Cu%C3%A9llar). The document was marked as "STRICTLY CONFIDENTIAL"

!["STRICTLY CONFIDENTIAL"](https://ageyev.github.io/img/Illustrations/documents/UN/how_to_expel_rf_from_un/1991-12-19_Fleischhauer_StrictlyConfidencial_Stamp.png)
...
On September 19, 1992, the UN Security Council adopted [Resolution 777 (1992)](https://ageyev.github.io/documents/un-ussr-rf/un/1992-09-19_UN_SC_Resolution_777_1992_en.png) which recognized that 1) the Socialist Federal Republic of Yugoslavia has ceased to exist, 2) therefore, the Federal Republic of Yugoslavia cannot continue automatically its membership in the UN.

On 22 September 1992, the General Assembly adopted [Resolution 47/1](https://ageyev.github.io/documents/un-ussr-rf/un/1992-09-22_UN_GA_Resolution_47-1_1992_en.png) with reference to the above-mentioned resolution of the Security Council, which also decided that the Federal Republic of Yugoslavia cannot continue automatically the membership of the former Socialist Federal Republic of Yugoslavia in the UN, must apply for membership as a new state, and before that must not take part in the work of the General Assembly.
...
![General Assembly resolution 2758 (XXVI)](https://ageyev.github.io/documents/un-ussr-rf/un/1971-10-25_UN_GA_Resolution_2758_en.png)

The important thing here is that the General Assembly actually recognized that the place of permanent member of the Security Council was "unlawfully occupied" for more than 20 years (the government of [Chiang Kai-shek](https://en.wikipedia.org/wiki/Chiang_Kai-shek) completely lost control of mainland China in 1950, and the decision was made in 1971)
...
>
> *Recalling* the UN Charter rules and principles of the international law concerning the succession and continuation of states, as well as concerning representation of states in the UN, which, in particular, were expressed before in General Assembly Resolution [2758 (XXVI) of 25.10.1971](https://ageyev.github.io/documents/un-ussr-rf/un/1971-10-25_UN_GA_Resolution_2758_en.png), Security Council Resolution [777 (1992) of 19.09.1992](https://ageyev.github.io/documents/un-ussr-rf/un/1992-09-19_UN_SC_Resolution_777_1992_en.png)  and General Assembly Resolution [47/1 of 22.09.1992](https://ageyev.github.io/documents/un-ussr-rf/un/1992-09-22_UN_GA_Resolution_47-1_1992_en.png)
>
> *Considering* the Union of Soviet Socialist Republics as a subject of international law no longer exists, as it was clearly and unambiguously stated in [Belovezh Accords 1991](https://ageyev.github.io/documents/un-ussr-rf/cis/1991-12-08_Belovezh_Accords_text_en.md), ratified by states - successors of the USSR, [including Russian Federation](https://ageyev.github.io/documents/un-ussr-rf/russia/1991-12-12_ratification.jpg), and also declared in the [Alma-Ata Protocols 1991](https://ageyev.github.io/documents/un-ussr-rf/un/1991-12-30_Buravkin_to_UN.pdf), and confirmed by the [Declaration no. 142-N of the Soviet of the Republics of the Supreme Soviet of the USSR](https://en.wikisource.org/wiki/Declaration_no._142-N_of_the_Soviet_of_the_Republics_of_the_Supreme_Soviet_of_the_USSR),
>
...
Although, as we described in ["How to overcome the "veto power" in the UN Security Council"](https://ageyev.github.io/UN/veto_power) there is a legal mechanism overcome the "veto power" and exclude the Russian Federation from voting on this issue.
...
Larry D. Johnson (as stated above former Principal Legal Officer in UN) in his publication ["United Nations Response Options to Russia’s Aggression: Opportunities and Rabbit Holes"](https://www.justsecurity.org/80395/united-nations-response-options-to-russias-aggression-opportunities-and-rabbit-holes/) refers to this Decision as a justification for the assertion that the Russian Federation is a continuing state to the USSR.
...
Estoppel is a judicial device whereby a person may be estopped (i.e. 'stopped') from [resiling](https://www.lsd.law/define/resile) from the existence of a particular state of affairs, due to their previous behavior or position.
...
Or may be it can be said that principle of [extinctive prescription](https://en.wikipedia.org/wiki/Extinctive_prescription), sometimes known as [laches](https://en.wikipedia.org/wiki/Laches_(equity)), can be applied here and may prevent challenging the occupation of a seat in the UN in general or in the Security Council in particular?
...
___
Thanks to ex-ambassador of Ukraine to the UN, US, RF, OSCE [Volodymyr Yelchenko](https://en.wikipedia.org/wiki/Volodymyr_Yelchenko), and to lawyer [Max Baryshnikov](https://www.linkedin.com/in/max-baryshnikov-a2465730/) for the help in working on the ideas presented in this text.
