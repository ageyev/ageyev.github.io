...
Шары в неотрытых ящиках находятся в состоянии "суперпозиции", т.е. каждый из них является черным и белым с одинаковой вероятностью, так же как многострадальный кот с одинаковой вероятностью является живым и мертвым. 
...
([бритвой Оккама](https://ru.wikipedia.org/wiki/%D0%91%D1%80%D0%B8%D1%82%D0%B2%D0%B0_%D0%9E%D0%BA%D0%BA%D0%B0%D0%BC%D0%B0) называют принцип "не множь сущности без крайней необходимости")
...
Пусть ящик с котом имеет некоторое количество окон, открыв которые такое же количество наблюдателей одновременно могут наблюдать состояние кота (жив или мертв), но при этом в момент наблюдения ни один из этих наблюдателей не может видеть другого и даже знать о его наличии, тем более о результатах наблюдения любого другого наблюдателя. Произведем наблюдение и сравним результаты полученные разными наблюдателями. 
