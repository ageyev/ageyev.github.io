...
:::tip Reading Arabic
This page contains Arabic text. To read Arabic more comfortably on multilingual pages, you may find my Chrome extension useful: [[Enlarge Arabic]](/tools/enlarge_arabic), which can be [installed](https://chromewebstore.google.com/detail/enlarge-arabic/cohiboahimednknkffilddeindcgpiop) from the Chrome Web Store.
:::
...
Indeed, Islam has a special term for this —
[tajdid](https://en.wikipedia.org/wiki/Islamic_revival)
(تجديد)
, meaning "renewal," derived from the root ج-د-د (j-d-d). From the same root comes the term [mujaddid](https://en.wikipedia.org/wiki/Mujaddid)
(مجدد)
— "renewer, reformer."

Innovations — [bid'ah](https://en.wikipedia.org/wiki/Bid%27ah)
(بدعة)
— are condemned in Islam, whereas tajdid — renewal through a return to the original meanings — is held to be good and necessary.

A key basis of this concept is the words of Muhammad transmitted in hadith [4291](https://sunnah.com/abudawud:4291) of Sunan Abu Dawud, the Book of "Al-Malahim" (Battles/Portents):
...
In this case the translation is mine. Islamic theologians debated the meaning of the expression عَلَى رَأْسِ — whether it means "at the beginning" or "at the end" (of the century). The prevailing view today is that it refers to the end of the century (contrary to the word's usual meaning), on the grounds that [Umar ibn Abd al-Aziz](https://en.wikipedia.org/wiki/Umar_ibn_Abd_al-Aziz), regarded as the first mujaddid, died in the year 101 of the Hijra, while [al-Shafi'i](https://en.wikipedia.org/wiki/Al-Shafi%27i) died in the year 204.
...
International law (in particular, Art. 2(3) of the [UN Charter](https://www.un.org/en/about-us/un-charter/full-text)) requires states to seek peaceful means of resolving disputes. Religious doctrines that influence an armed conflict must be the subject of open, documented, well-argued, and publicly verifiable dialogue. And this is the path to peace, and to truth.
...
The [Sahaba](https://en.wikipedia.org/wiki/Companions_of_the_Prophet) (الصحابة) — the founders of Islam, the companions of the Prophet Muhammad — were not people originally raised or educated within the Islamic tradition. And the great caliph Umar ([Umar ibn al-Khattab](https://en.wikipedia.org/wiki/Umar)) was originally an opponent of Islam and intended to kill Muhammad for having defamed the religion of the ancestors and condemned the worship of idols.

Many of the companions came to understanding before meeting the Prophet (Umar read the Quran in his sister's house; the first Medinan Muslims sent people to Muhammad in Mecca to learn the Quran). The claim that a modern reader cannot understand the Quran without already being a Muslim beforehand would contradict the Islamic doctrine of the Quran as a clear exposition — bayan بَيَان, see [3:138](https://quran.com/3/138) (the same Semitic root: ב-י-נ (b-y-n) — "to understand, to distinguish," from which also בִּינָה (binah — "understanding")).
...
A vivid example here is the slogan that Hamas chose for its war with Israel, which it named the "Al-Aqsa Flood" ([Al-Aqsa Flood](https://www.palestinechronicle.com/wp-content/uploads/2024/01/PDF.pdf)). This slogan was a quotation from the Quran, [5:23](https://quran.com/5?startingVerse=23):
...
And finally, the most interesting point. The Quran itself appeals to the position of knowledgeable people from the Judeo-Christian tradition as a criterion even for Muhammad himself. In verse [10:94](https://quran.com/10?startingVerse=94):
...
Tahrif al-maʿna (تَحْرِيف الْمَعْنَى) — "distortion of meaning":
the text of the Torah and the Gospel is authentic, but Jews and Christians misunderstand or misinterpret it.
*The text itself has not been changed.*
...
Tahrif al-lafz (تَحْرِيف اللَّفْظ) — "distortion of the [actual] wording/text":
the very text of the Torah and the Gospel has been physically corrupted: fragments cut out, fragments added, words substituted.
*The text in its present form is not authentic.*

In support of this interpretation (in particular, in the article on [Tahrif](https://en.wikipedia.org/wiki/Tahrif) on Wikipedia) one sometimes cites hadith [Sahih al-Bukhari 7363](https://sunnah.com/bukhari:7363), which transmits the words of [Ibn Abbas](https://en.wikipedia.org/wiki/Ibn_Abbas):
...
But in the same "Sahih al-Bukhari," in the section "Kitab al-Tawhid" / كتاب التوحيد, al-Bukhari gives the same statement of Ibn Abbas as in hadith [7363](https://sunnah.com/bukhari:7363), in a fuller formulation that includes an important clarification:
...
Characteristically, this text is present on sunnah.com (see [Book 97](https://sunnah.com/bukhari/97) at the beginning of the (55) Chapter, before hadith 7553), but *without an English translation* — only the Arabic original. See also in Arabic on [islamweb.net](https://www.islamweb.net/ar/library/content/0/7226/).
...
The idea of "tahrif al-lafz" (corruption of the text itself) as a systematic doctrine was introduced and substantiated only later — by [Ibn Hazm](https://en.wikipedia.org/wiki/Ibn_Hazm) in the 11th century CE (see [Theodore Pulcini. Exegesis as Polemical Discourse: Ibn Hazm on Jewish and Christian Scriptures (1998)](https://www.amazon.co.uk/Exegesis-Polemical-Discourse-Christian-Scriptures/dp/0788503960)).

Ibn Hazm based himself on a study of the text of the Torah, which he found too divergent from his own conceptions of Islam. Ibn Hazm advanced the hypothesis that, after the destruction of Jerusalem by the Babylonians, the Torah was lost, and that the existing text of the Torah was composed by [Uzayr](https://en.wikipedia.org/wiki/Uzair) ([Ezra](https://en.wikipedia.org/wiki/Ezra)) after the return from the Babylonian captivity.
...
See, for example, the assertion of [Zakir Naik](https://en.wikipedia.org/wiki/Zakir_Naik), one of the most popular contemporary [da'is](https://en.wikipedia.org/wiki/Da%27i) (Islamic preachers):
...
In this text, however, I will examine the arguments in favor of the view that the concept of "tahrif al-lafzi" (a corrupted text) of the [Tawrat](https://en.wikipedia.org/wiki/Torah_in_Islam) (the Torah) is mistaken, and that, consequently, the correct interpretation of "tahrif" is precisely the one that originally existed in Islam.
...
> ...and to *confirm* the Torah revealed before me...
> (English translation: Dr. Mustafa Khattab)
...
> And ˹remember˺ when Jesus, son of Mary, said, "O children of Israel! I am truly Allah's messenger to you, *confirming* the Torah which came before me...
> (English translation: Dr. Mustafa Khattab)


A more literal (my own) translation of verse [61:6](https://quran.com/61?startingVerse=6):

> And Jesus, son of Mary, said: O children of Israel, I am the *messenger of Allah* (rasūlu-llāhi / رَسُولُ ٱللَّهِ — the same expression by which Muhammad is designated in the [shahada](https://en.wikipedia.org/wiki/Shahada)) to you, *confirming* (muṣaddiqan / مُّصَدِّقًۭا) *that Tawrat (Torah) which is in my hands* (li-mā bayna yadayya mina t-tawrāti / لِّمَا بَيْنَ يَدَىَّ مِنَ ٱلتَّوْرَىٰةِ).
...
(1) [The "Dead Sea Scrolls"](https://en.wikipedia.org/wiki/Dead_Sea_Scrolls)
...
(3) [The Samaritan Pentateuch](https://en.wikipedia.org/wiki/Samaritan_Pentateuch)
...
The Samaritan Pentateuch contains differences, but apart from the designation of the principal cultic site (for the Samaritans this is Mount Gerizim), the rest are differences that, although numerous, are minor and do not substantially affect the meaning of the text. That is, on the whole we have before us the same text as the [Masoretic Text](https://en.wikipedia.org/wiki/Masoretic_Text) and the [Septuagint](https://en.wikipedia.org/wiki/Septuagint). Moreover, the Samaritan Pentateuch is written in the ancient Hebrew alphabet ([paleo-Hebrew alphabet](https://en.wikipedia.org/wiki/Paleo-Hebrew_alphabet)), which the Jews used even before the Babylonian captivity.

(4) And, finally, the [Masorah (מסורה)](https://he.wikipedia.org/wiki/%D7%9E%D7%A1%D7%95%D7%A8%D7%94) itself — the tradition of preserving the [text](https://en.wikipedia.org/wiki/Masoretic_Text) of the Tanakh, including the Pentateuch, in Judaism. A tradition rich in written sources, which — contrary to the notions widespread among contemporary Muslims — testifies that the Jews treated the preservation of the Torah's text with the utmost scrupulousness.
...
"With them" (عِندَهُمُ — indahumu) here means "with the Jews"; see the preceding verse 5:41 — the reference is to hādū — [هَادُوا۟](https://corpus.quran.com/qurandictionary.jsp?q=hwd#(5:41:19)), literally "those who became/are Jews."

It is interesting here that [5:43](https://quran.com/5?startingVerse=43) follows [5:41](https://quran.com/5?startingVerse=41), in which it is said of the Jews (or part of them) that they "distort the meaning of the words, taking them out of context" (يُحَرِّفُونَ الْكَلِمَ مِن بَعْدِ مَوَاضِعِهِ), which is precisely tahrif.

But one should note that, at the same time, those Jews — as is stated in [5:43](https://quran.com/5?startingVerse=43) — have "the Torah containing the judgment (the law) of Allah" (ٱلتَّوْرَىٰةُ فِيهَا حُكْمُ ٱللَّهِ). That is, here it is plainly evident that the very text on hand among them does indeed contain the judgment (the law) of Allah, even though they "distort the meaning of the words" — i.e. interpret it incorrectly.
...
This is a continuation of what was set out in the preceding verse [2:91](https://quran.com/2?startingVerse=91), but here the one who is *confirming* (مُصَدِّقٌۭ — musaddiqun) what the children of Israel have is Muhammad himself.
...
Under Abu Bakr ([Abu Bakr](https://en.wikipedia.org/wiki/Abu_Bakr)) — the first caliph — Zayd ibn Thabit ([Zayd ibn Thabit](https://en.wikipedia.org/wiki/Zayd_ibn_Thabit)), at the initiative of Umar ([Umar](https://en.wikipedia.org/wiki/Umar)), gathered the fragments of the Quran from "flat stones, palm leaves, the shoulder-blades of animals, and the memory of people." This compilation was kept by Abu Bakr, then by Umar, then by his daughter Hafsa ([Hafsa bint Umar](https://en.wikipedia.org/wiki/Hafsa_bint_Umar)) — one of Muhammad's wives.

Under Uthman ([Uthman](https://en.wikipedia.org/wiki/Uthman)) — the third caliph — a new standardized version was created on the basis of Zayd's compilation. After this, Uthman sent out copies to the provinces and ordered all the other versions to be burned — including the versions belonging to the companions.

This is a documented historical fact that the Islamic tradition itself does not deny. The burning of the alternative versions is confirmed in the most authoritative Sunni sources — in "Sahih al-Bukhari" (hadith [4987](https://sunnah.com/bukhari:4987)) it is directly described how Uthman ordered all the copies to be burned except the Uthmanic recension.
...
The preservation of the primary sources — the shoulder-blades, leaves, stones, and early manuscripts — would have been a natural action for those confident in the accuracy of the compilation. They would have served as proof of authenticity — this is exactly how the Jews kept the scrolls of the Torah until they wore out, and then ritually interred them in a genizah ([genizah](https://en.wikipedia.org/wiki/Genizah)), but did not destroy them.

Moreover, Uthman ordered the burning of the Quranic copies (mushafs) of Ubayy ibn Ka'b ([Ubayy ibn Ka'b](https://en.wikipedia.org/wiki/Ubayy_ibn_Ka%27b)) — Muhammad's secretary — and of Abdullah ibn Mas'ud ([Abd Allah ibn Mas'ud](https://en.wikipedia.org/wiki/Abd_Allah_ibn_Mas'ud)). And this despite the fact that, according to the collection "Sahih al-Bukhari" (hadiths [3758](https://sunnah.com/bukhari:3758), [3760](https://sunnah.com/bukhari:3760), [4999](https://sunnah.com/bukhari:4999)), the Prophet Muhammad himself ordered the Muslims to learn the Quran *precisely from Ibn Mas'ud and from Ubayy*. Early Muslim historians (Muhammad ibn Sa'd ([Ibn Sa'd](https://en.wikipedia.org/wiki/Ibn_Sa%27d))) related that Ibn Mas'ud did not recognize Zayd — who, unlike Ibn Mas'ud himself, had not been approved by Muhammad as an authority on questions of the Quran's text — and called on the Muslims to hide their mushafs.

There exist reliable hadiths — for example, from Aisha ([Sahih Muslim 1452 a](https://sunnah.com/muslim:1452a)) or from Umar ([Sahih al-Bukhari 6830](https://sunnah.com/bukhari:6830)) — that mention verses which were known to the companions but did not enter Uthman's mushaf: the verse about stoning or the verse about the breastfeeding of adults. In hadith [Sahih Muslim 1050](https://sunnah.com/muslim:1050) Abu Musa al-Ash'ari (a companion of Muhammad) speaks of two lost suras.
...
Yes, one may believe that the editorial commission that compiled the "Quran of Uthman" ([Uthmanic codex](https://en.wikipedia.org/wiki/Uthmanic_codex)) strove to transmit the content of Muhammad's preaching in the best possible way.
...
Let us give a simple example. Verse [9:30](https://quran.com/9?startingVerse=30):
...
If the Quran is, in the literal (not metaphorical) sense, an exact copy of a "preserved tablet" residing in the heavens, from which [the archangel Jibril](https://en.wikipedia.org/wiki/Jibril) took texts that were then recorded with exactitude in the earthly text of the Quran, then this single error about Ezra demolishes the entire construction.
...
The Quran itself architecturally presupposes that the preceding Scripture is a verifying layer (see verses [10:94](https://quran.com/10?startingVerse=94), [21:7](https://quran.com/21?startingVerse=7)); the use of the Tawrat as a hermeneutic key for Quranic obscurities is its own instruction.

In particular, if one acknowledges that we have the authentic text of the Tawrat, this makes it possible to resolve unequivocally the dispute about which son is meant in verses [37:99-113](https://quran.com/37?startingVerse=99). Standard classical Islamic exegesis of the early period identified the sacrificial son as [Isaac](https://en.wikipedia.org/wiki/Isaac_in_Islam). Later commentators, by now striving to interpret it differently from the Jews, interpret it as [Ishmael](https://en.wikipedia.org/wiki/Ishmael_in_Islam). But if one uses the Tawrat as the hermeneutic support ([Bereshit 22](https://mechon-mamre.org/p/pt/pt0122.htm)), the answer becomes unequivocal: the sacrificial son is Isaac.

This move works not only for the [Aqedah](https://en.wikipedia.org/wiki/Binding_of_Isaac). It works for dozens of Quranic passages about figures of the Tanakh, where the Quran briefly mentions what the Tawrat recounts at length. If the Tawrat is a verifying layer, then many obscure passages of the Quran become clear. Thus, a serious reading of the Quran requires turning to the text of the Tawrat wherever the Quran sets out briefly what the Tawrat sets out at length.

And such an approach follows the early Islamic tradition. [Isra'iliyyat](https://en.wikipedia.org/wiki/Isra%CA%BCiliyyat) (إسرائیلیات — [Israʼiliyyat](https://en.wikipedia.org/wiki/Isra%CA%BCiliyyat)) — an entire genre of early tafsir ([tafsīr](https://en.wikipedia.org/wiki/Tafsir)), the tradition of interpreting the Quran, in which the interpreters turned to Jewish sources for precisely this purpose. Subsequently, for political reasons, Islam moved away from this tradition, but as is evident from the results of our inquiry, there are grounds to return to it.
...
(4) The Tawrat — i.e. the Torah/Pentateuch — must be recognized, alongside the Quran, as a foundational text of the Quranic tradition, and, in particular, as a basis for the interpretation ([tafsir](https://en.wikipedia.org/wiki/Tafsir)) of the Quran, for the resolution of questions concerning Jerusalem and the Holy Land, for the content of the Tanakhic (i.e. ancient-Islamic) prophecies, and for the relations between the Islamic ummah and the people of Israel.
...
[Efraim Kholmiansky, Meir Antopolsky, Pinchas Polonsky. Jews and Islam: A History of the Conflict and a Path to Dialogue. Jerusalem, Orot Yerushalayim, 2022](https://pinchaspolonsky.org/evrei-i-islam/)
